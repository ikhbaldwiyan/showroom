...
function Settings(props) {
  ...
  const { roomId, hideTime, setHideTime, hideName, setHideName, hideViews, setHideViews, profile, hideMenu, setHideMenu, hideMultiMenu, setHideMultiMenu, hideStars, setHideStars } = props
    ...
    <div style={inline} className="ml-1 mt-1">
      <Dropdown style={inline} direction="up" isOpen={isOpen} toggle={toggle} direction={direction}>
        ...
        <DropdownMenu>
          ...
          <ProfileModal roomId={roomId} className="btn-sm mt-1 px-4 mb-1" buttonLabel="Show Profile" />
